 ...
 */
final class Version20230716160912 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users CHANGE totp totp BIGINT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users CHANGE totp totp VARCHAR(255) DEFAULT NULL');
    }
}
